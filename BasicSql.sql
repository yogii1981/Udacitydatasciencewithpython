...
# When you use the BETWEEN operator in SQL, do the
# results include the values of your endpoints, or not?
# Figure out the answer to this important question by writing
#  a query that displays the order date and gloss_qty data
